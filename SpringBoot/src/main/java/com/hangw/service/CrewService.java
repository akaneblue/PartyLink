...
public class CrewService {
	...
	public Crews create(String name, int max, String discription, Interest category, LocalDate date, LocalDate date2, LocalTime time, String location, Users leader, String imagePath) {
	...
	public List<Crews> getCrewsByCategory(Interest category, int page, int size){
		Pageable pageable = (Pageable) PageRequest.of(page, size);
	...
	public Page<Crews> getCrewsByLeader(Users leader, int page) {
	    return crewRepository.findByLeader(leader, PageRequest.of(page, 3));
	}

	// GroupService
	public List<Crews> searchCrewsByKeyword(String keyword, int page, int size) {
	    Pageable pageable = PageRequest.of(page, size);
	    return crewRepository.findByNameContainingIgnoreCase(keyword, pageable);
	}
